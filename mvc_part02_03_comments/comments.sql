...
-- 제약 조건 정보 확인
SELECT * FROM information_schema.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_SCHEMA = 'develop_spring' AND TABLE_NAME = 'tbl_comment';

-- 댓글 삽입
INSERT INTO tbl_comment(bno, content, author) VALUES (1, '1번 게시글의 댓글', '윤딴딴');

INSERT INTO tbl_comment(bno, content, author) VALUES (1, '1번 게시글의 2번째 댓글', '홍길동');

INSERT INTO tbl_comment(bno, content, author) VALUES (2, '범인은 바로 너다!', '코난');

INSERT INTO tbl_comment(bno, content, author) VALUES (2, '범인은 바로 코난이다!', '명탐정');
...
SELECT * FROM tbl_comment WHERE bno = 2 ORDER BY cno DESC 
