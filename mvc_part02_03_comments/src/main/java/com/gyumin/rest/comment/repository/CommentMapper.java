package com.gyumin.rest.comment.repository;
...
public interface CommentMapper {
	 ...
	 * @return - 수정된 행의 개수
	 */
	@Update("UPDATE tbl_comment SET content = #{content}, author= #{author}, updatedate = now() WHERE cno = #{cno}")
...
//	List<CommentVO> listPage(Map<String, Object> map) throws Exception;
	List<CommentVO> listPage(@Param("bno") int bno, @Param("cri") Criteria cri) throws Exception; // @Param - map 객체로 만들어줘서 전달해주는 것 (꼭 Map으로 설정해줘야하므로)
}
