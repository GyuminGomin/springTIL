package com.gyumin.rest.controller;
...
import com.gyumin.rest.vo.SampleVO;
...
public class SampleController {
	...
	@GetMapping("sample")
	public String getSample(String name, int age, SampleVO vo, Model model) {
	...
	/**
		BeanNameViewResolver를 대신하는 annotation
	*/
