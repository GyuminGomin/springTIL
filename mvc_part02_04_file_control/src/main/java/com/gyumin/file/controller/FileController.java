package com.gyumin.file.controller;
...
import com.gyumin.file.vo.FileVO;
...
public class FileController {
	...
	public void FileControllerInit() {
		// Controller Bean 생성이 되고 난 후 의존성 주입까지 완료되면
		// 서버 구동전 최초에 한 번 호출되는 method
		...
		// File.separator : 운영체제에 맞는 디렉토리 구분자 제공 (window \\, linux /)
	...
	public String uploadForm(
		...
		if (!uploadDir.exists()) {
			uploadDir.mkdirs();
			System.out.println(uploadDir.getAbsolutePath() + "Dir 생성 완료");
		}
		...
		*/
		...
		// file.transferTo(uploadFile); // multipart 객체가 자동으로 위치에 전송해줌
	...
	public String uploadFile(String original, byte[] fileData) throws IOException {
		String savedName = "";
		UUID uuid = UUID.randomUUID(); // 총 32개의 랜덤한 문자 + 4개의 - 으로 조합된 36개의 문자
	...
	public String uploadForm1(// @RequestParam("file") MultipartFile[] files
