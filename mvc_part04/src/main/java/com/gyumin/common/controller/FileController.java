package com.gyumin.common.controller;
...
import com.gyumin.common.util.FileUtil;
...
public class FileController {
	 ...
	 *  - 해당되는 운영체제의 절대 경로를 얻기 위한 application context 객체
	 */
	...
	public ResponseEntity<byte[]> displayFile(String fileName) throws Exception {
		...
		return new ResponseEntity<>(FileUtil.getBytes(realPath, fileName), FileUtil.getHeaders(fileName), HttpStatus.OK);
	}
